                    ...
                    {loading ? (  
                        ...
                        <>  
                            ...
                            <button  
                                ...
                                className={`btn-custom ${location.pathname === "/signup" && "text-red-500"}`}  
                            >  
                                Sign Up  
                            </button>  
                            ...
                            <button  
                                ...
                                className={`btn-custom ${location.pathname === "/login" && "text-red-500"}`}  
                            >  
                                Login  
                            </button>  
                        </>  
                        ...
                        <>  
                            ...
                            >  
                                <FiShoppingCart />  
                                {/* Cart Badge (Replace this with cart state if needed) */}  
